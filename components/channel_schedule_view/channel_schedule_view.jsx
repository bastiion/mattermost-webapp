...
export default class ChannelScheduleView extends React.PureComponent {
    static propTypes = {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (props.match.url !== state.url && props.channelId !== state.channelId) {
            updatedState = {deferredPostView: ChannelScheduleView.createDeferredPostView(), url: props.match.url, focusedPostId};
        }
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            prevChannelId: '',
            deferredPostView: ChannelScheduleView.createDeferredPostView(),
        };
    }
    ...
    componentDidUpdate(prevProps) {
        if (prevProps.channelId !== this.props.channelId || prevProps.channelIsArchived !== this.props.channelIsArchived) {
            mark('ChannelScheduleView#componentDidUpdate');

            const [dur1] = measure('SidebarChannelLink#click', 'ChannelScheduleView#componentDidUpdate');
            const [dur2] = measure('TeamLink#click', 'ChannelScheduleView#componentDidUpdate');

            clearMarks([
                'SidebarChannelLink#click',
                'ChannelScheduleView#componentDidUpdate',
                'TeamLink#click',
            ]);
